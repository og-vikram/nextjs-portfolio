    ...
    <div className="flex flex-1 h-screen max-h-fit flex-col">
      ...
      >
        <Particles
          ...
          className=" w-full absolute z-0 h-screen max-h-fit"
        ></Particles>
      </motion.div>
      {/* Greeting */}
      <div className="mt-40 flex flex-col justify-center items-center">
        <motion.div
          ...
          className="flex flex-col items-center justify-center w-full font-dmSans z-2"
        >
          <h1 className="text-white text-5xl md:text-6xl xl:text-7xl z-10">
            hi, i&apos;m{" "}
            <span className="bg-gradient-to-r from-fuchsia-600 to-pink-600 font-bold bg-clip-text text-transparent">
              vikram!
            </span>
          </h1>
          <h2 className="text-white text-3xl md:text-4xl lg:text-5xl mt-2">
            cs student{" "}
          ...
          <h3 className="text-white mt-8 text-2xl md:text-2xl lg:text-3xl">
            <FontAwesomeIcon icon={faLocation} className="pr-4" /> NJ / NYC
          </h3>
        </motion.div>
        {/* Spotify Widget */}
        <motion.div
          ...
          className="text-white mt-56 md:mt-56 lg:mt-80 font-dmSans z-2 w-5/6 sm:w-96 text-base"
        >
          <a
            target="_blank"
        ...
        <motion.div
          ...
          className="text-white flex gap-8 text-4xl mt-8 md:mt-20 z-10 pb-20"
        >
          <a href="https://github.com/og-vikram">
            <FontAwesomeIcon
              icon={faGithub}
          ...
          <a href="https://open.spotify.com/user/mmarkiv7">
            <FontAwesomeIcon
              icon={faSpotify}
              className="z-10 hover:text-spotify transition-colors duration-200"
            />
          </a>
        </motion.div>
      </div>
